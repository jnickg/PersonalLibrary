...
//   and to set premiumVersion to true if you're doing the Premium version
...
public class Assignment3
{
	...
	public static void main(String[] args)
	{
		...
		Item		item;
		boolean		premiumVersion = true;			// set to true if doing Premium version
		
		out.printf("CS261 - Assignment 3 (%s) - Nick Giampietro%n%n", premiumVersion ? "Premium" : "Regular");
		...
		if (premiumVersion) {	// set premiumVersion to true if doing Premium version
			// remove items
